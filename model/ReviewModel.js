...
var ReviewModel = /** @class */ (function () {
    function ReviewModel(DB_CONNECTION_STRING) {
    ...
    ReviewModel.prototype.addReview = function (response, review) {
        return __awaiter(this, void 0, void 0, function () {
            var newReview, result, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    ReviewModel.prototype.updateReview = function (response, reviewID, updatedReview) {
        return __awaiter(this, void 0, void 0, function () {
            var result, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.updateOne({ reviewID: reviewID }, updatedReview)];
                    case 1:
                        result = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.deleteOne({ reviewID: reviewID })];
                    case 1:
                        result = _a.sent();
    ...
    ReviewModel.prototype.getReviewsByCourse = function (response, courseID) {
        return __awaiter(this, void 0, void 0, function () {
            var reviews, e_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.find({ courseID: courseID })];
                    case 1:
                        reviews = _a.sent();
    ...
    ReviewModel.prototype.getReviewsByUser = function (response, userID) {
        return __awaiter(this, void 0, void 0, function () {
            var reviews, e_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.find({ userID: userID })];
                    case 1:
                        reviews = _a.sent();
                        response.json(reviews);
                        return [3 /*break*/, 3];
