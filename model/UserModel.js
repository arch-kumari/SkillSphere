...
var UserModel = /** @class */ (function () {
    ...
    UserModel.prototype.changePassword = function (response, userID, newPassword) {
        return __awaiter(this, void 0, void 0, function () {
            var result, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.updateOne({ userID: userID }, { password: newPassword })];
                    case 1:
                        result = _a.sent();
    ...
    UserModel.prototype.deleteAccount = function (response, userID) {
        return __awaiter(this, void 0, void 0, function () {
            var result, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.deleteOne({ userID: userID })];
                    case 1:
                        result = _a.sent();
